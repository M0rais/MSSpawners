package pt.morais.spawner.adapter.v1_14_R1.spawner;
...
public class NBTSpawnerAdapter extends pt.morais.spawner.adapter.spawner.NBTSpawnerAdapter {
    ...
    public NBTSpawner getNBTSpawner(BlockState blockState, boolean defaultParams) {
        return new pt.morais.spawner.adapter.v1_14_R1.spawner.NBTSpawner(blockState, defaultParams);
    }

    @Override
    public NBTSpawner getNBTSpawner(BlockState blockState) {
        return new pt.morais.spawner.adapter.v1_14_R1.spawner.NBTSpawner(blockState, false);
    }
